...
| Current task | The parked-row follow-up batches promoted `0x62`, `0x6e`, `0x71`, `0x86`, simple Component text rows `0x70`, `0x72`, `0x79`, `0x7a`, empty ItemStack rows `0x60`, `0x66`, `0x6c`, entity/runtime rows `0x63`, `0x83`, `0x87`, and scoped default-spawn/scoreboard/NBT/game-test rows `0x61`, `0x6a`, `0x6d`, `0x7b`, `0x7e` into jar-backed oracle packages and Stevenarella dispatch mappings. The official Protocol 775 Play CLIENTBOUND table currently ends at `0x8c`. The immediate next unproven pointer is `0x64`, and remaining parked rows stay parked unless a future official-source pass names safe fixtures. |
...
For the next Protocol 775 Play CLIENTBOUND task:
  ...
  -> especially parked: `0x64`, `0x6b`, `0x74`-`0x75`, `0x7d`, `0x82`, `0x84`-`0x85`, `0x8a`, `0x8c`; non-promoted branches of `0x61`, `0x6a`, `0x6d`, `0x7b`, and `0x7e` remain unsupported
