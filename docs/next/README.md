...
For the next structure-cleanup slice:
  -> start from the committed Login, Configuration, Play clientbound, and Play scoreboard internal-protocol extraction
