...
For the next structure-cleanup slice:
  -> start from the committed Login, Configuration, Play clientbound, Play scoreboard, Play sound, and Play update internal-protocol extraction
