...
| Current task | The parked-row follow-up batches promoted `0x62`, `0x6e`, `0x71`, `0x86`, simple Component text rows `0x70`, `0x72`, `0x79`, `0x7a`, empty ItemStack rows `0x60`, `0x66`, `0x6c`, entity/runtime rows `0x63`, `0x83`, `0x87`, scoped default-spawn/scoreboard/NBT/game-test rows `0x61`, `0x6a`, `0x6d`, `0x7b`, `0x7e`, scoped empty/movement rows `0x7d`, `0x82`, `0x85`, `0x8a`, and combined registry-holder rows `0x75`, `0x84`, `0x8c` into jar-backed oracle packages and Stevenarella dispatch mappings. The official Protocol 775 Play CLIENTBOUND table currently ends at `0x8c`; remaining safe-row work is blocked on entity relationship/context policy for `0x64`, `0x6b`, and `0x74`. |
...
For the next Protocol 775 Play CLIENTBOUND task:
  ...
  -> do not disturb the final parked YELLOW rows without a new entity fixture policy
  -> there are no further Play CLIENTBOUND rows after `0x8c` in the official table
  -> remaining Play CLIENTBOUND route is blocked on entity relationship/context policy
