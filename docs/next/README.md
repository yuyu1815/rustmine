...
For the next structure-cleanup slice:
  -> start from the committed Login, Configuration, Play clientbound, Play scoreboard, Play sound, Play update, Play entity, and Play text internal-protocol extraction
