...
For the next structure-cleanup slice:
  -> start from the committed Login, Configuration, Play clientbound, Play scoreboard, and Play sound internal-protocol extraction
