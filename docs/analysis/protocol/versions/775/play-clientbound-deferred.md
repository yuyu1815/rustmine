...
| Entity relationship / metadata / movement / projectile | `0x64`, `0x6b`, `0x74`, `0x7d`, `0x84` | Empty metadata `0x63`, empty attributes `0x83`, and primitive projectile power `0x87` have been promoted with bounded fixture policy. Remaining rows still need initialized entity, registry, sound/effect, relationship, or movement fixture evidence. | Partly promoted; relationship/sound/effect/teleport rows still parked. |
...
| Registry / world / game data | `0x75`, `0x82`, `0x85`, `0x8a` plus non-default branches of `0x61` | `LevelData.RespawnData.DEFAULT` for `0x61` has been promoted as a bounded default fixture. | Partly promoted; sound/advancement/recipe/waypoint and non-default spawn semantics still parked. |
