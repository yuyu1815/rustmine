...
| `network_login_configuration` | [phases/network_login_configuration.md](phases/network_login_configuration.md) | `partial` | `configuration_keepalive_codec` and `configuration_keepalive_framed_dispatch` jar-backed answers regenerated and exact Rust oracle tests passed against the current Leafish checkout | Add runtime reaction and Configuration completion cases |
