...
| `network_login_configuration` | [phases/network_login_configuration.md](phases/network_login_configuration.md) | `partial` | `configuration_keepalive_codec` proves one Configuration serverbound packet id/body only | Add runtime reaction and Configuration completion cases |
