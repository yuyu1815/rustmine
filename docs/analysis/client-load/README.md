...
| `network_login_configuration` | [phases/network_login_configuration.md](phases/network_login_configuration.md) | `partial` | `configuration_keepalive_codec` jar-backed answer regenerated and exact Rust oracle test passed against the current Leafish checkout | Add Configuration packet dispatch/decode, runtime reaction, and Configuration completion cases |
