...
| `network_login_configuration` | [phases/network_login_configuration.md](phases/network_login_configuration.md) | `partial` | `configuration_keepalive_codec`, `configuration_keepalive_framed_dispatch`, and `configuration_finish_framed_terminal` jar-backed answers regenerated and exact Rust oracle tests passed against the current Leafish checkout | Add runtime keep-alive reaction and runtime Configuration-to-Play transition proof |
