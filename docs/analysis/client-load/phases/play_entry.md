...
| Candidate evidence gap | Continue official Play table packet-support in order at `minecraft:commands` / `0x10`, then define transition answer and smoke milestone. |
