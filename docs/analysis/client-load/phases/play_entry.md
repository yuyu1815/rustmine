...
| Candidate evidence gap | Continue official Play table packet-support in order at `minecraft:container_close` / `0x11`, then define transition answer and smoke milestone. |
...
root-only command tree fixture; they do not prove runtime entry into Play.
