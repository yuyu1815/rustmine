...
| Candidate evidence gap | Continue official Play table packet-support in order at `minecraft:chunk_batch_start` / `0x0c`, then define transition answer and smoke milestone. |
