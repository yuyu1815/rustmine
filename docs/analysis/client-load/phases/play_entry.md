...
| Candidate evidence gap | Continue official Play table packet-support in order at `minecraft:clear_titles` / `0x0e`, then define transition answer and smoke milestone. |
...
`minecraft:chunks_biomes` / `0x0d` empty chunkBiomeData-list fixture; they do
not prove runtime entry into Play.
