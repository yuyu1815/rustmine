...
| Candidate evidence gap | Continue official Play table packet-support in order at `minecraft:chunk_batch_finished` / `0x0b`, then define transition answer and smoke milestone. |
...
`minecraft:change_difficulty` / `0x0a` difficulty/locked fixture; they do not
prove runtime entry into Play.
