...
| Candidate evidence gap | Continue official Play table packet-support in order at `minecraft:command_suggestions` / `0x0f`, then define transition answer and smoke milestone. |
...
boolean fixture; they do not prove runtime entry into Play.
