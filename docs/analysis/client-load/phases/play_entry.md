...
| Candidate evidence gap | Continue official Play table packet-support in order at `minecraft:change_difficulty` / `0x0a`, then define transition answer and smoke milestone. |
...
/ `0x09` UUID remove-operation fixture; they do not prove runtime entry into
Play.
