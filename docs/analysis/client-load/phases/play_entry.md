...
| Candidate evidence gap | Continue official Play table packet-support in order at `minecraft:cooldown` / `0x16`, then define transition answer and smoke milestone. |
...
`0x15` Identifier key fixture; they do not prove non-empty ItemStack/component
...
runtime behavior, or runtime entry into Play.
