...
`minecraft:container_close` / `0x11` container id fixture; they do not prove
menu lifecycle behavior, screen close behavior, inventory state, or runtime
entry into Play.
