...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:show_dialog` / `0x12`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
