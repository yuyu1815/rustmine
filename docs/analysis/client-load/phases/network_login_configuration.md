...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:registry_data` / `0x07`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
