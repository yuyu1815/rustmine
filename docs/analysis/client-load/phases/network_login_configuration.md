...
## Current Login Clientbound Cookie Request Packet Slice

```text
login_cookie_request_clientbound_framed_dispatch
  -> official Login clientbound minecraft:cookie_request frame
    from oracle/answers/775/login_cookie_request_clientbound_framed_dispatch.answer.jsonl
  -> packet::packet_by_id(775, State::Login, Direction::Clientbound, official id, body)
    -> current result: LoginCookieRequest packet with official Identifier key and full body consumption
```
