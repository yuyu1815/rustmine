...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:resource_pack_pop` / `0x08`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
