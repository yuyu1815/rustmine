...
| Candidate evidence gap | Add the next Configuration packet-support proof, then add full `spawn_reader` keep-alive reaction and runtime Configuration-to-Play transition proof. |
...
`configuration_resource_pack_response_framed_dispatch`, backed by official jar
