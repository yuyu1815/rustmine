...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:resource_pack_push` / `0x09`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
