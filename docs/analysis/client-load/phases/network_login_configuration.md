...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:server_links` / `0x10`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
