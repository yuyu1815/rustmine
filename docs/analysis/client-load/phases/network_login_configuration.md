...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:custom_report_details` / `0x0f`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
