...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:code_of_conduct` / `0x13`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
