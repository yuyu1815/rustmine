...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:update_tags` / `0x0d`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
