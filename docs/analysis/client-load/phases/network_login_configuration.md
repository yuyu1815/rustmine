...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:select_known_packs` / `0x0e`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
