...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:disconnect` / `0x02`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
