...
| Candidate evidence gap | For packet-support loop, next missing Configuration clientbound packet proof is likely `minecraft:update_enabled_features` / `0x0c`; runtime Configuration-to-Play, registry hydration, and Play readiness remain later gaps. |
