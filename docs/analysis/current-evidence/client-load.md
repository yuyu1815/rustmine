...
`play_change_difficulty_clientbound_framed_dispatch`, jar-backed,
...
spawn readiness, world load, render readiness, or client-load completion. The
next packet-support target by official Play clientbound table order is
`minecraft:chunk_batch_finished` / `0x0b`.
