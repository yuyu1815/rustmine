...
`play_chunk_batch_start_clientbound_framed_dispatch`, jar-backed,
...
client-load completion. The next packet-support target by official Play
clientbound table order is `minecraft:chunks_biomes` / `0x0d`.
