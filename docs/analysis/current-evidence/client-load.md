...
`play_container_set_slot_clientbound_framed_dispatch`, jar-backed,
...
readiness, or client-load completion. The next packet-support target by
official Play clientbound table order is `minecraft:cookie_request` / `0x15`.
