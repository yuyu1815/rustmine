...
`play_container_set_content_clientbound_framed_dispatch`, jar-backed,
...
world load, render readiness, or client-load completion. The next
packet-support target by official Play clientbound table order is
`minecraft:container_set_data` / `0x13`.
