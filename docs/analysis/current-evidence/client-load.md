...
| `play_entry` | `partial` | `play_bundle_delimiter_clientbound_framed_dispatch` | Play clientbound bundle_delimiter framed dispatch/decode for the official registered empty-body singleton | successful entry into Play, bundle grouping behavior, world load, spawn readiness, render readiness |
