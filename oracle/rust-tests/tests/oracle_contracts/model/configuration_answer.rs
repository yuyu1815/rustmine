...
struct ConfigurationOracleAnswer {
    ...
    stream_decoded_source: Option<String>,
    decoded_source: Option<String>,
    input_sound_holder: Option<String>,
    stream_decoded_sound_location: Option<String>,
    decoded_sound_location: Option<String>,
    input_volume: Option<f32>,
    stream_decoded_volume: Option<f32>,
    decoded_volume: Option<f32>,
    input_seed: Option<i64>,
    stream_decoded_seed: Option<i64>,
    decoded_seed: Option<i64>,
    input_effect_holder: Option<String>,
    stream_decoded_effect_description_id: Option<String>,
    decoded_effect_description_id: Option<String>,
    input_amplifier: Option<i32>,
    stream_decoded_amplifier: Option<i32>,
    decoded_amplifier: Option<i32>,
    input_effect_duration: Option<i32>,
    stream_decoded_effect_duration: Option<i32>,
    decoded_effect_duration: Option<i32>,
    input_ambient: Option<bool>,
    stream_decoded_ambient: Option<bool>,
    decoded_ambient: Option<bool>,
    input_visible: Option<bool>,
    stream_decoded_visible: Option<bool>,
    decoded_visible: Option<bool>,
    input_show_icon: Option<bool>,
    stream_decoded_show_icon: Option<bool>,
    decoded_show_icon: Option<bool>,
    input_blend: Option<bool>,
    stream_decoded_blend: Option<bool>,
    decoded_blend: Option<bool>,
    ...
    input_reset: Option<bool>,
    stream_decoded_reset: Option<bool>,
    decoded_reset: Option<bool>,
    input_show_advancements: Option<bool>,
    stream_decoded_show_advancements: Option<bool>,
    decoded_show_advancements: Option<bool>,
    input_added_count: Option<usize>,
    stream_decoded_added_count: Option<usize>,
    decoded_added_count: Option<usize>,
    input_removed_count: Option<usize>,
    stream_decoded_removed_count: Option<usize>,
    decoded_removed_count: Option<usize>,
    input_progress_count: Option<usize>,
    stream_decoded_progress_count: Option<usize>,
    decoded_progress_count: Option<usize>,
    ...
    destination_entity_class: Option<String>,
    destination_entity_id: Option<i32>,
    vehicle_entity_class: Option<String>,
    vehicle_entity_id: Option<i32>,
    passenger_entity_class: Option<String>,
    passenger_entity_id: Option<i32>,
    vehicle_passenger_count: Option<i32>,
    game_test_fixture: Option<String>,
    stream_decoded_source_entity_id: Option<i32>,
    decoded_source_entity_id: Option<i32>,
    stream_decoded_destination_entity_id: Option<i32>,
    decoded_destination_entity_id: Option<i32>,
    stream_decoded_vehicle_entity_id: Option<i32>,
    decoded_vehicle_entity_id: Option<i32>,
    stream_decoded_passenger_entity_ids: Option<Vec<i32>>,
    decoded_passenger_entity_ids: Option<Vec<i32>>,
    input_position_x: Option<f64>,
    stream_decoded_position_x: Option<f64>,
    decoded_position_x: Option<f64>,
    input_position_y: Option<f64>,
    stream_decoded_position_y: Option<f64>,
    decoded_position_y: Option<f64>,
    input_position_z: Option<f64>,
    stream_decoded_position_z: Option<f64>,
    decoded_position_z: Option<f64>,
    input_relative_count: Option<usize>,
    stream_decoded_relative_count: Option<usize>,
    decoded_relative_count: Option<usize>,
    input_packed_item_count: Option<usize>,
    stream_decoded_packed_item_count: Option<usize>,
    decoded_packed_item_count: Option<usize>,
    input_item_set_count: Option<usize>,
    stream_decoded_item_set_count: Option<usize>,
    decoded_item_set_count: Option<usize>,
    input_stonecutter_recipe_count: Option<usize>,
    stream_decoded_stonecutter_recipe_count: Option<usize>,
    decoded_stonecutter_recipe_count: Option<usize>,
    ...
    input_waypoint_uuid: Option<String>,
    input_waypoint_id: Option<String>,
    stream_decoded_waypoint_id: Option<String>,
    decoded_waypoint_id: Option<String>,
