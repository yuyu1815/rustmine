...
fn configuration_cookie_request_framed_dispatch_matches_official_oracle_answer() {
    let manifest: TestManifest = read_json("oracle/test-manifests/775/configuration_cookie_request_framed_dispatch.test-manifest.json");
    assert_eq!(manifest.case_id, "configuration_cookie_request_framed_dispatch");
    assert_eq!(
        manifest.contract_path,
        "oracle/contracts/775/configuration_cookie_request_framed_dispatch.contract.json"
    );
    assert_eq!(manifest.answer_path, "oracle/answers/775/configuration_cookie_request_framed_dispatch.answer.jsonl");
    ...
    assert_runner_scope("oracle/test-manifests/775/configuration_cookie_request_framed_dispatch.test-manifest.json", &manifest);
