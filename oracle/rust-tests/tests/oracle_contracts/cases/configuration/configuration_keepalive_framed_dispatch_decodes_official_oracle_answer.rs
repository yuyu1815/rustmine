...
fn configuration_keepalive_framed_dispatch_decodes_official_oracle_answer() {
    let manifest: TestManifest = read_json("oracle/test-manifests/775/configuration_keepalive_framed_dispatch.test-manifest.json");
    assert_eq!(manifest.case_id, "configuration_keepalive_framed_dispatch");
    assert_eq!(
    ...
    assert_runner_scope("oracle/test-manifests/775/configuration_keepalive_framed_dispatch.test-manifest.json", &manifest);
