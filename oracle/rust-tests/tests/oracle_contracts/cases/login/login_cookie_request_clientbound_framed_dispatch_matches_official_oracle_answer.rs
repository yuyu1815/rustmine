...
fn login_cookie_request_clientbound_framed_dispatch_body() {
    let manifest: TestManifest = read_json("oracle/test-manifests/775/login_cookie_request_clientbound_framed_dispatch.test-manifest.json");
    assert_eq!(manifest.case_id, "login_cookie_request_clientbound_framed_dispatch");
    assert_eq!(
    ...
    assert_runner_scope("oracle/test-manifests/775/login_cookie_request_clientbound_framed_dispatch.test-manifest.json", &manifest);
