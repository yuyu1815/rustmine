...
fn play_block_destruction_clientbound_framed_dispatch_body() {
    let manifest: TestManifest = read_json("oracle/test-manifests/775/play_block_destruction_clientbound_framed_dispatch.test-manifest.json");
    assert_eq!(manifest.case_id, "play_block_destruction_clientbound_framed_dispatch");
    assert_eq!(
    ...
    assert_runner_scope("oracle/test-manifests/775/play_block_destruction_clientbound_framed_dispatch.test-manifest.json", &manifest);
